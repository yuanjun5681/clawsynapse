...
Node A                                         Node B
  ...
  |<----------------------------------------------|
  |                                               |
  | challenge.ack + signature                    |
  |---------------------------------------------->|
  |                                               |
  |        身份已确认：A <-> B authenticated       |
  |                                               |
  | trust.request + reason + signature           |
  |---------------------------------------------->|
  |                                               |
  |                     pending                   |
  |                                               |
  | trust.response(approve) + signature          |
  |<----------------------------------------------|
  |                                               |
  |            双方进入 trusted 状态              |
  |                                               |
...
- `poll_pending_trust`：拉取并清空待处理的 trust request
- `respond_trust`：对待处理请求返回 approve / reject
